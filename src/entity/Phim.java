...
public class Phim {
	...
	public String toString() {
		return "Phim [maPhim=" + maPhim + ", tenPhim=" + tenPhim + ", theLoai=" + theLoai + ", daoDien=" + daoDien
				+ ", thoiLuong=" + thoiLuong + ", ngayCongChieu=" + ngayCongChieu + ", ngonNgu=" + ngonNgu
				+ ", quocGia=" + quocGia + ", trangThai=" + trangThai + ", ngayBatDau=" + ngayBatDau + ", giaThau="
				+ giaThau + ", anh=" + anh + ", doanPhimGioiThieu=" + doanPhimGioiThieu + ", tomTat=" + tomTat + "]";
	}
}
