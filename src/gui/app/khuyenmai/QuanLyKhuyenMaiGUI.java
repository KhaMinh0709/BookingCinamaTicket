...
public class QuanLyKhuyenMaiGUI extends JPanel implements ActionListener {
	...
	public QuanLyKhuyenMaiGUI() {
		...
		btnThem.setIcon(new FlatSVGIcon("gui/app/khuyenmai/icon/add.svg", 20, 20));
		pnlRow1.add(btnThem);
		
		
		btnSua = new JButton("Sửa");
		FlatSVGIcon icon = new FlatSVGIcon("gui/app/khuyenmai/icon/update.svg", 20, 20);
...
//		pnlNor.add(Box.createVerticalStrut(30));
		...
		btnXoa.setIcon(new FlatSVGIcon("gui/app/khuyenmai/icon/delete.svg", 15, 18));
		pnlRow1.add(btnXoa);
	...
	private void sua() {
		...
		if (index == -1) {
	        ...
	        UIManager.put("Button.background", Color.decode("#3f9daf"));
