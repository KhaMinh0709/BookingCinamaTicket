...
public class Menu extends JPanel implements MouseListener{
	...
	private final String menuItems[][] = { { "~Quản lý~" }, { "Phim" }, { "Lịch chiếu" },
			{ "Nhân viên" }, { "Khách hàng" }, { "Sản phẩm", "Đồ ăn", "Nước uống" }, {"Khuyến mãi"},
			{ "~Khác~" }, { "Thống kê", "General", "Customer", "Movie", "Product" },
...
//		lightDarkMode.setMenuFull(menuFull);
	...
	private void init(String role) {
		...
		header.setIcon(new FlatSVGIcon("gui/icon/svg/logo.svg", 40, 40));
